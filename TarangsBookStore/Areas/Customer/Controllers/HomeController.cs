...
namespace TarangsBooks.Ares.Customer.Controllers
{
    [Area("Customer")]
    public class HomeController : Controller
    {
        ...
        {
            return View(new TarangsBookStore.Models.ViewModels.ErrorViewModel { RequestId = Activity.Current?.Id ?? HttpContext.TraceIdentifier });
        }
    }
}